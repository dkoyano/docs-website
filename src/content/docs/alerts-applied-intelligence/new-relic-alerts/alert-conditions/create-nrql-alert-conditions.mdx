...
4. Follow the steps explained in the [Create a NRQL alert condition from a policy](#alert-condition-from-policy) but be aware that step 1 is a bit different because, now, you see the query already built with the data you've previously configured.
